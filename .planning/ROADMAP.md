...
- [x] **Phase 3: Admin Picker & Identity-Rich Display** — Searchable Prime user picker replaces email textareas; admin lists, group lists, and audit log show name + division
...
**Plans**: 5 plans
  ...
  - [x] 03-04-PLAN.md — Wave 3: extract VisibilityTab; wire picker on Dashboard Admins / GroupCard / New Group + refresh button + cascade rows (ADMIN-01..05, DISPLAY-01, DISPLAY-02)
  - [x] 03-05-PLAN.md — Wave 4: extract AuditTab; wire D-15 cascade + prime_user_miss tooltip + CSV column rename via downloadCSV (DISPLAY-03)
**UI hint**: yes
...
| 3. Admin Picker & Identity-Rich Display | 5/5 | Complete | 2026-04-25 |
